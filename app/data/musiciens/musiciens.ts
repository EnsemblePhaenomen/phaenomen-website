import type { Musicien, Chef } from "@/app/types/musiciensConfig";
...
const musiciens: Musicien[] = [
  ...
  {
    nom: "Ishikawa-Terajima",
    prénom: "Riho",
    instrument: "Clavecin",
    bio: `Née au Japon, Riho ISHIKAWA-TERAJIMA est diplômée du département de piano de l’université de Tokyo Gakugei. Au même moment, elle étudie le clavecin avec Marie Nishiyama. Elle a participé à des master classes avec Christophe Rousset en Italie, Corina Marti au Japon et Kenneth Weiss, Skip Sempe en France.
...
Riho a participé à des concerts dans le cadre du festival «Toulouse les Orgues», «Mars en Baroque», «Torroella de Montgrí», «Quincena Musical de San Sebastián» et Festival international de Santander. Elle fait partie de l’ensemble « La Nébuleuse » dirigé par Gabriel Rignol. Elle a participé au spectacle « Trauernacht» , l’opéra de Lyon dirigé par Simon-Pierre Bestion de Camboulas.`,
    portrait: {
      src: "/ensembleGallery/photos des musiciens/Riho_TERAJIMA_Ishikawa.jpg",
      alt: "Portrait de la claveciniste Riho Ishikawa-Terajima",
    },
    modal: {
      src: "/ensembleGallery/photos des musiciens/Riho_TERAJIMA_Ishikawa.jpg",
      alt: "Portrait de la claveciniste Riho Ishikawa-Terajima",
...
const musiciensData = { musiciens, chef };
export default musiciensData;
