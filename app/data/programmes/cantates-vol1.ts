import { Programme } from "@/app/types/programmeConfig";

export const programmeCantatesVolI: Programme = {
  title: "L’Intégrale des Cantates Vol. I : cantates pour choeur, cordes et continuo",
  sections: [
    {
      title: "Cantates pour choeur, cordes et continuo",
      works: [
        {
    ...
    {
      title: "Autres choeurs d’entrée (manuscrit « Vierzehn Kirchenmusiken »)",
      works: [
