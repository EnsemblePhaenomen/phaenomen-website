            ...
            <section className=" mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 bg-blue-200 pt-4 md:pt-16">
                    ...
                    <div className="md:w-1/4">
                        <div
                            className="hidden lg:block lg:h-full lg:aspect-auto w-full aspect-[1/3] border border-neutral-400"
                        />
                    ...
                    <div className="md:w-3/4 flex flex-col gap-8 text-sm leading-relaxed">
                        ...
                        <section className="pt-4">
                            ...
                            >
                                <div className={`mr-3 md:mr-4 flex-shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1 ${
